...
impl Changelist {
    ...
    pub fn add_change_from(&mut self, row: usize, col: usize, prev_value: TriState, new_value: TriState) {
...
impl<T> From<T> for Changelist where T: Iterator<Item = GridChange> {
